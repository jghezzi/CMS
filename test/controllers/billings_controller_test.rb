...
class BillingsControllerTest < ActionController::TestCase
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post :create, billing: { bill_date: @billing.bill_date, consultant_id: @billing.consultant_id, hours: @billing.hours, project_id: @billing.project_id, sow_id: @billing.sow_id }
    end
  ...
  test "should update billing" do
    patch :update, id: @billing, billing: { bill_date: @billing.bill_date, consultant_id: @billing.consultant_id, hours: @billing.hours, project_id: @billing.project_id, sow_id: @billing.sow_id }
    assert_redirected_to billing_path(assigns(:billing))
  end
